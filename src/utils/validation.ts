...
const errorStyles = `color: #bae6fd; background-color: #881337; padding: 4px 8px; border: 1px dashed #bae6fd; border-radius: 4px; font-family: monospace; font-size: 14px;`;
